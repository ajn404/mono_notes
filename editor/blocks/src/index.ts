...
if (env[importIdentifier] === true) {
    ...
    console.error(
        '@notes/blocks was already imported. This breaks constructor checks and will lead to issues!'
    );
}

if (typeof window === 'undefined') {
    throw new Error(
        'Seems like you are importing @notes/blocks in SSR mode. Which is not supported for now.'
    );
}
